...
<g>
  ...
  />
      ...
      <div class="project">
        <div class="image-container">
          <img src="../../assets/img/nordbo-robotics.jpg" alt="Project Nordbo Robotics">
        </div>
        <div class="project-info">
          <p class="project-category">WEB APP</p>
          <div class="project-info-title-section">
            <h2>Nordbo Robotics</h2>
            <div class="empty-space"></div>
            <div class="project-info-button-container">
              <a target="_blank" href="#">
                  <svg stroke="#ffffff" stroke-width="1.1" width="1.8em" height="1.8em" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  />
          ...
          <div class="project-info-coding-lang">
            <span class="span-javascript">JavaScript</span>
            <span class="span-firebase">Firebase</span>
          </div>
          <p class="project-info-text">{{ $t("projects.nordbo_robotics") }}</p>
          <div class="project-info-button-wrapper">
            <RouterLink to="/wip">
              <button>
                {{ $t("projects.read_more") }}
      ...
      <div class="project">
        <div class="image-container">
          <img src="../../assets/img/ucl.jpg" alt="Project UCL">
        </div>
        <div class="project-info">
          <p class="project-category">WEB APP</p>
          <div class="project-info-title-section">
  ...
  />
          ...
          <div class="project-info-coding-lang">
            <span class="span-javascript">JavaScript</span>
            <span class="span-csharp">C#</span>
          </div>
          <p class="project-info-text">{{ $t("projects.ucl") }}</p>
          <div class="project-info-button-wrapper">
            <RouterLink to="/wip">
              <button>
                {{ $t("projects.read_more") }}
