    ...
    <div class="project-wrapper">
      ...
      <div class="project">
        <div class="image-container">
          <img src="../../assets/img/sejs-pizza.jpg" alt="Project Pizza">
        </div>
        <div class="project-info">
          <p class="project-category">WEB APP</p>
          <div class="project-info-title-section">
            <h2>Sej's Pizza</h2>
            <div class="empty-space"></div>
            <div class="project-info-button-container">
              <a target="_blank" href="https://github.com/sej3686/sej-pizza-del">
                  <svg stroke="#ffffff" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" viewBox="0 0 100 100" width="2em" height="2em" xmlns="http://www.w3.org/2000/svg" fill="none">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M48.854 0C21.839 0 0 22 0 49.217c0 21.756 13.993 40.172 33.405 46.69 2.427.49 3.316-1.059 3.316-2.362 0-1.141-.08-5.052-.08-9.127-13.59 2.934-16.42-5.867-16.42-5.867-2.184-5.704-5.42-7.17-5.42-7.17-4.448-3.015.324-3.015.324-3.015 4.934.326 7.523 5.052 7.523 5.052 4.367 7.496 11.404 5.378 14.235 4.074.404-3.178 1.699-5.378 3.074-6.6-10.839-1.141-22.243-5.378-22.243-24.283 0-5.378 1.94-9.778 5.014-13.2-.485-1.222-2.184-6.275.486-13.038 0 0 4.125-1.304 13.426 5.052a46.97 46.97 0 0 1 12.214-1.63c4.125 0 8.33.571 12.213 1.63 9.302-6.356 13.427-5.052 13.427-5.052 2.67 6.763.97 11.816.485 13.038 3.155 3.422 5.015 7.822 5.015 13.2 0 18.905-11.404 23.06-22.324 24.283 1.78 1.548 3.316 4.481 3.316 9.126 0 6.6-.08 11.897-.08 13.526 0 1.304.89 2.853 3.316 2.364 19.412-6.52 33.405-24.935 33.405-46.691C97.707 22 75.788 0 48.854 0z" fill="none"/></svg>
              </a>
              <a target="_blank" href="https://comfy-gecko-177088.netlify.app/">
                  <svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 width="2em" height="2em" viewBox="0 0 72 72" enable-background="new 0 0 72 72" xml:space="preserve">
<g>
	<g>
	...
	<g>
		<path d="M40.297,51.043c-2.877,0-5.784-0.844-8.323-2.606l-0.538-0.375c-2.718-1.888-4.731-4.674-5.669-7.845
			...
			c6.62,4.598,8.264,13.717,3.67,20.33l-13.93,18.59C49.453,48.868,44.914,51.043,40.297,51.043z" fill="#ffffff"/>
	</g>
	<g>
		<path d="M52.76,33.106c-0.209,0-0.419-0.065-0.599-0.2c-0.442-0.331-0.532-0.958-0.2-1.399l0.548-0.73
			c0.331-0.442,0.959-0.53,1.399-0.2c0.442,0.331,0.532,0.958,0.2,1.399l-0.548,0.73C53.364,32.969,53.064,33.106,52.76,33.106z" fill="#ffffff"/>
	</g>
	<g>
		<path d="M55.047,30.056c-0.209,0-0.419-0.065-0.599-0.2c-0.442-0.331-0.532-0.958-0.2-1.399l4.426-5.904
			...
			C55.651,29.918,55.352,30.056,55.047,30.056z" fill="#ffffff"/>
	</g>
</g>
</svg>
              </a>
      ...
      <div class="project">
        <div class="image-container">
          <img src="../../assets/img/projectreCraft.jpg" alt="Project Pizza">
        </div>
        <div class="project-info">
          ...
          <div class="project-info-title-section">
            ...
            <div class="project-info-button-container">
              <a target="_blank" href="#">
                  <svg stroke="#ffffff" stroke-width="1.1" width="1.8em" height="1.8em" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path
    fill-rule="evenodd"
    clip-rule="evenodd"
  ...
  />
      ...
      <div class="project">
        <div class="image-container">
          <img src="../../assets/img/rtid-2.jpg" alt="Project RTID by LUDO">
        </div>
        <div class="project-info">
          ...
          <div class="project-info-title-section">
            ...
            <div class="empty-space"></div>
            <div class="project-info-button-container">
              <a target="_blank" href="https://www.rtidbyludo.com/">
                  <svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 width="2em" height="2em" viewBox="0 0 72 72" enable-background="new 0 0 72 72" xml:space="preserve">
<g>
	<g>
	...
	<g>
      ...
      <div class="project">
        <div class="image-container">
          <img src="../../assets/img/llr-2.jpg" alt="Project Lifeline Robotics">
        </div>
        <div class="project-info">
          <p class="project-category">WEBSITE</p>
          <div class="project-info-title-section">
            ...
            <div class="empty-space"></div>
            <div class="project-info-button-container">
              <a target="_blank" href="https://lifeline.sej.one/">
                  <svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 width="2em" height="2em" viewBox="0 0 72 72" enable-background="new 0 0 72 72" xml:space="preserve">
<g>
	<g>
	...
	<g>
      ...
      <div class="project">
        <div class="image-container">
          <img src="../../assets/img/webdock-2.jpg" alt="Project Webdock">
        </div>
        <div class="project-info">
          <p class="project-category">WEB APP</p>
          <div class="project-info-title-section">
            ...
            <div class="empty-space"></div>
            <div class="project-info-button-container">
              <a target="_blank" href="https://github.com/jacobdolleris/webdock-bachelor">
                  <svg stroke="#ffffff" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" viewBox="0 0 100 100" width="2em" height="2em" xmlns="http://www.w3.org/2000/svg" fill="none">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M48.854 0C21.839 0 0 22 0 49.217c0 21.756 13.993 40.172 33.405 46.69 2.427.49 3.316-1.059 3.316-2.362 0-1.141-.08-5.052-.08-9.127-13.59 2.934-16.42-5.867-16.42-5.867-2.184-5.704-5.42-7.17-5.42-7.17-4.448-3.015.324-3.015.324-3.015 4.934.326 7.523 5.052 7.523 5.052 4.367 7.496 11.404 5.378 14.235 4.074.404-3.178 1.699-5.378 3.074-6.6-10.839-1.141-22.243-5.378-22.243-24.283 0-5.378 1.94-9.778 5.014-13.2-.485-1.222-2.184-6.275.486-13.038 0 0 4.125-1.304 13.426 5.052a46.97 46.97 0 0 1 12.214-1.63c4.125 0 8.33.571 12.213 1.63 9.302-6.356 13.427-5.052 13.427-5.052 2.67 6.763.97 11.816.485 13.038 3.155 3.422 5.015 7.822 5.015 13.2 0 18.905-11.404 23.06-22.324 24.283 1.78 1.548 3.316 4.481 3.316 9.126 0 6.6-.08 11.897-.08 13.526 0 1.304.89 2.853 3.316 2.364 19.412-6.52 33.405-24.935 33.405-46.691C97.707 22 75.788 0 48.854 0z" fill="none"/></svg>
              </a>
              <a target="_blank" href="http://www.bachelor.sej.one/">
                  <svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 width="2em" height="2em" viewBox="0 0 72 72" enable-background="new 0 0 72 72" xml:space="preserve">
<g>
	<g>
	...
	<g>
      ...
      <div class="project">
        <div class="image-container">
          <img src="../../assets/img/recraft-website.jpg" alt="Project Pizza">
        </div>
        <div class="project-info">
          <p class="project-category">UI/UX</p>
          <div class="project-info-title-section">
            <h2>ReCraft Website</h2>
            <div class="empty-space"></div>
            <div class="project-info-button-container">
              <a target="_blank" href="#">
                  <svg stroke="#ffffff" stroke-width="1.1" width="1.8em" height="1.8em" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
