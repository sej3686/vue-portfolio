    ...
    <div class="project-info">
      ...
      <div class="project-info-title-section">
        ...
        <div class="project-info-button-container">
          ...
          <a v-if="project.live" target="_blank" :href="project.live">
            <svg
              fill="#000000"
              version="1.1"
              id="Layer_1"
          ...
          <a v-if="project.figma" target="_blank" :href="project.figma">
            <svg
              stroke="#ffffff"
              stroke-width="1.1"
              width="1.8em"
      ...
      <div class="project-info-coding-lang">
        <span           v-for="lang in transformedLanguages"
          :key="lang.original"
          :class="'span-' + lang.original">{{ lang.display }}</span>
      </div>
      <p class="project-info-text">{{ $t(`projects.${project.id}`) }}</p>
      <div class="project-info-button-wrapper">
        <RouterLink :to="{ name: 'ProjectDetails', params: { id: project.id } }" >
          <button>
...
export default {
    ...
    transformedLanguages() {
      ...
      return this.project.languages.map((lang) => ({
        original: lang,
        display: languageMapping[lang] || lang, 
      }));
    },
  },
};
