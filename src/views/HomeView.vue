  ...
  <div class="container">
    ...
    <header>
      ...
      <section class="header-box-wrapper">
        ...
        <a class="call-to-action" href="#keyword"
    ...
    <section ref="keyword" id="keyword">
      ...
      <main class="keyword-grid-wrapper reveal">
        <div class="keyword-grid-item">
          ...
          <h3>Coder</h3>
          <p>
            When I'm not busy doing other things I code personal projects for
            fun. I've been doing various projects
          </p>
        </div>
        <div class="keyword-grid-item">
          ...
          <h3>Designer</h3>
          <p>
            I have experience in various Adobe programs and I can easly make
            videos and edit images!
          </p>
        </div>
        <div class="keyword-grid-item">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
    ...
    <section id="projects" ref="comp">
      ...
      <div class="project-wrapper reveal">
        ...
        <div class="desc">
          ...
          <p>
            The website was made to be their new offical website.
